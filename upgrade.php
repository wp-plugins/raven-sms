<?php
	if( is_admin() ) {
		...
		$installer_wpravensms_ver = get_option('wp_ravensms_db_version');
		
		if( $installer_wpravensms_ver < WP_SMS_VERSION ) {
			...
			update_option('wp_ravensms_db_version', WP_RAVENSMS_VERSION);
		}
	}
?>
